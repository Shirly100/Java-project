...
public class CarConst
{
    ...
    public static Order ContentValuesToOrder(ContentValues contentValues) {
        ...
        order.setRental_srart_date(contentValues.getAsString(contentValues.getAsString(CarConst.OrderConst.RENTAL_START_DATE)));
        order.setRental_end_date(contentValues.getAsString(contentValues.getAsString(CarConst.OrderConst.RENTAL_END_DATE)));
